...
|---|---|---|---|---|
| 2012（更新日不詳） | [`<data>` element変更提案](../../raw/www.w3.org/wiki/User%3ATantekelik/data_element)（[公開元](https://www.w3.org/wiki/User:Tantekelik/data_element)） | HTML WG変更提案 | 導入理由、代替案、2011年のrough consensusとeditor追加済み定義。 | 2026-08-09 |
