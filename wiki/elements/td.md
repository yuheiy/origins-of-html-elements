...
WHATWG HTML Living Standardでは、tableのdata cellを表す。 [HTML Living Standard](../../raw/html-living-standard/tables.html)（[公開版](https://html.spec.whatwg.org/multipage/tables.html#the-td-element)、2026-08-09確認）
...
|---|---|---|---|---|
| 1993-11-08 | [HTML+ §9](../../raw/html-plus/htmlplus_39.html)（[公開元](https://www.w3.org/MarkUp/HTMLPlus/htmlplus_39.html)） | Internet-Draft | `TD`を含む単純table modelを定義する。 | 2026-08-09 |
...
| 1997-01-14 | [HTML 3.2](../../raw/html-3.2/index.html)（[公開元](https://www.w3.org/TR/REC-html32#table)） | W3C Recommendation | 広く実装されたtable subsetとして`TD`を採録する。 | 2026-08-09 |
