...
WHATWG HTML Living Standardでは、親`table`の列見出し（headers）と付随する見出し以外のセルからなるrowsのblockを表す。[HTML Living Standard](../../raw/html.spec.whatwg.org/multipage/tables.html)（[公開版](https://html.spec.whatwg.org/multipage/tables.html#the-thead-element)、2026-08-09確認）
