...
1992年6月の初出DTD、11月の導入者による説明、公開RCS履歴を再監査したが、Connollyは一般のSGMLパーサーのため自ら導入したと述べるだけで、参照した特定のDTDを挙げない。以後は6月2日以前のDTD草稿またはRCS revision、Connollyの編集メモ、あるいは先行DTDからの採用を明記する同時代の通信が新たに公開された場合にだけ再開する。
