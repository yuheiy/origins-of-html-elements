...
> 状態: 完成（敵対的レビュー済み: 2026-08-09）。1992年DTDでの導入主体と理由を検証済み（直前祖先は未確認）
...
1992年6月Connolly DTD、1992年11月の当事者mail、CERN HTMLタグ一覧、1993年HTML Internet-Draftを確認した。明示tagの有無とSGML上の要素構造を混同していない。対象群全体は[初期SGML/GML調査ノート](../research/early-sgml-elements.md)を参照する。

2026-08-09の敵対的レビューでは、1992-06-02生成DTDと11月のConnollyによる導入説明を再読し、CERNの省略可能なSGML framingとの文脈を比較した。Connolly以前の具体的document elementは確認できず、導入主体・理由のみを確定するB判定を維持した。
