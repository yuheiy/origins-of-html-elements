...
WHATWG HTML Living Standardでは、引用または参照されるものを含むworkのtitleを表す。 [一次定義](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-cite-element)（2026-08-09確認）
