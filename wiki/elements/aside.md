...
| 2005-09-01 | [Web Applications 1.0](../../raw/whatwg.org/specs/web-apps/2005-09-01/__index)（[公開元](https://whatwg.org/specs/web-apps/2005-09-01/#the-aside)） | WHATWG保存Early Working Draft | `aside`の存在と、周囲へ間接的に関連するセクションという意味。 | 2026-08-09 |
| 2008-01-22 | [HTML 5 differences from HTML 4](../../raw/www.w3.org/TR/2008/WD-html5-diff-20080122/__index)（[公開元](https://www.w3.org/TR/2008/WD-html5-diff-20080122/#new-elements)） | W3C Working Draft | `aside`をHTML 4にない文書マークアップとして列挙。 | 2026-08-09 |
