...
| 2007-03-29 | [*Web Applications 1.0*, revision 699](../../raw/platform.html5.org/history/webapps/r699.html)（[公開元](https://platform.html5.org/history/webapps/r699.html#video)） | WHATWG保存仕様 | videoまたはmovieを表すメディア要素、fallback、共通media API、当時の主用途。 | 2026-08-09 |
