...
WHATWG HTML Living Standardでは、順序を変えると文書の意味が変わるよう意図的に並べられた項目のlistを表す。 [HTML Living Standard](../../raw/html.spec.whatwg.org/multipage/grouping-content.html)（[公開版](https://html.spec.whatwg.org/multipage/grouping-content.html#the-ol-element)、2026-08-09確認）
