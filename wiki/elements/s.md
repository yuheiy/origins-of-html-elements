...
| 2010-04-06〜2010-09-29 | [W3C Bug 9429, “Unobsolete the `<strike>` element”](../../raw/www.w3.org/Bugs/Public/show_bug.cgi-fbca4c889bfb6216)（[公開元](https://www.w3.org/Bugs/Public/show_bug.cgi?id=9429)） | 標準化バグ・編集者回答 | `S`／`STRIKE`の再採録提案、`DEL`と区別する意味の形成、`STRIKE`ではなく`S`を選ぶ編集判断。 | 2026-08-09 |
