...
> 状態: 完成（敵対的レビュー済み: 2026-08-09）。2005年HTML5 `m`から2008年`mark`への改名を検証済み
...
2026-08-09の敵対的レビューでは、2005年仕様の`m`定義と2008年commitの`m`→`mark`改名・意味の連続を原文で再確認した。`m`以前の祖先や改名を促した議論は見つからなかったが、直接の改名記録があるためA判定を維持した。
