...
一次定義: [WHATWG HTML Living Standardの `<selectedcontent>` 定義](https://html.spec.whatwg.org/multipage/form-elements.html#the-selectedcontent-element)（2026-08-09確認）。定義内容の要約は未作成。
