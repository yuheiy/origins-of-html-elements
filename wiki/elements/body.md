...
Tim Berners-Leeは1992年6月にヘッダー／本文分離案を示し、Dan Connollyの7月公開DTDは`BODY`を混在内容回避用の本文コンテナーとして宣言した。11月には内部版の`DOCUMENT`を`BODY`へ戻す具体案が支持され、1993年1月6日版DTDへ続いた。`DOCUMENT`を含む内部版DTDは回収できていない。
...
- `DOCUMENT`を含む内部版DTDと`BODY`へ戻した変更差分を回収できるか。
