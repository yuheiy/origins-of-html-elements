...
HTML+の数学提案全体はLaTeXの手法に着想を得たと明記するが、`SUP`という要素名自体をLaTeXから借りたとは述べない。[HTML+ math](../../raw/www.w3.org/MarkUp/HTMLPlus/htmlplus_45.html)（[公開元](https://www.w3.org/MarkUp/HTMLPlus/htmlplus_45.html)）
