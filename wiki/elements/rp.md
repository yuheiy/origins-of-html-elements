...
敵対的レビュー（2026-08-09）では、1998年草案、2001年Recommendation、2008年commitの各`rp`定義を再照合し、三要素を一括採録した記録より強い個別経路がないことを確認した。IE実装、既存Web利用、組版慣習は採用元を特定できないため矢印を追加せず、A−を維持した。
