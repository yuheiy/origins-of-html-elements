...
| 1992-02-11（HTTP Last-Modified） | WorldWideWeb `test_source.txt` | CERN/W3C保存の実装test source | `MENU`と`LI`による実例を含む。保存日時はLine Mode Browser 1.2aの記録区間より早いが、作成日、実装日、公開日のどれかは確定できない。 | [W3C](https://www.w3.org/Test/test_source.txt) | 2026-08-10 |
