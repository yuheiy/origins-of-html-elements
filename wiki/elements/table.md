...
WHATWG HTML Living Standardでは、複数の次元を持つデータをtable形式で表す。 [一次定義](https://html.spec.whatwg.org/multipage/tables.html#the-table-element)（2026-08-09確認）
...
|---|---|---|---|---|---|
| 1993-11-08 | HTML+ §9 | Internet-Draft | `TABLE`を含む単純table modelを定義する。 | [一次資料](https://www.w3.org/MarkUp/HTMLPlus/htmlplus_39.html) | 2026-08-09 |
...
| 1997-01-14 | HTML 3.2 | W3C Recommendation | 広く実装されたtable subsetとして`TABLE`を採録する。 | [一次資料](https://www.w3.org/TR/REC-html32#table) | 2026-08-09 |
