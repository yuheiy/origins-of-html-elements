...
2009年9月17日のW3C Bug 7657は、`dt`／`dd`を`dl`、`figure`、`details`で異なる構造と意味に再利用することによる作者の混乱を問題にした。Bug 7669は`figure`専用キャプション要素と、キャプション以外の内容を直接置く単純な構造を求めた。コメントではIE 6／7が`dl`外の`dt`／`dd`から期待と異なるDOMを作る後方互換性問題も報告され、HTML WG ISSUE-83へ昇格した。[Bug 7657](../../raw/www.w3.org/Bugs/Public/show_bug.cgi-2867df8a72c94218)（[公開元](https://www.w3.org/Bugs/Public/show_bug.cgi?id=7657)） [Bug 7669](../../raw/www.w3.org/Bugs/Public/show_bug.cgi-e603fef40f4a1959)（[公開元](https://www.w3.org/Bugs/Public/show_bug.cgi?id=7669)） [ISSUE-83](../../raw/www.w3.org/html/wg/tracker/issues/83)（[公開元](https://www.w3.org/html/wg/tracker/issues/83)）

ISSUE-83の変更提案は、後方互換性、既存スタイルシートとの衝突、不適切な既定スタイル、`dl`との構造・意味の違い、不要な本文ラッパーを理由に`dt`／`dd`の廃止を求め、HTMLの構造化要素には専用の子要素を使う設計パターンから`figcaption`案を提示した。2010年1月30日の仕様コミットは`figure`のキャプションを`figcaption`へ、本文を直接のフロー内容へ変更した。HTML WGはこの編集を受けてISSUE-83を円満な解決として閉じた。[同時代の変更提案](../../raw/wiki.whatwg.org/index.php-ab175fe94c92f193)（[公開元](https://wiki.whatwg.org/index.php?title=Change_Proposal:_figure_and_details&oldid=4382)） [仕様コミットと親差分](../../raw/github.com/whatwg/html/commit/c397495115b089ec52dbec45021159051134445f)（[公開元](https://github.com/whatwg/html/commit/c397495115b089ec52dbec45021159051134445f)） [ISSUE-83](../../raw/www.w3.org/html/wg/tracker/issues/83)（[公開元](https://www.w3.org/html/wg/tracker/issues/83)）
...
最初の矢印は`details`へ出された`dt`／`dd`再利用案をHicksonが`figure`にも適用した変更である。次の矢印はBug 7657／ISSUE-83で記録された意味・構造・後方互換性の問題を解消するための専用キャプション要素への置換である。[2009年の公開メール](../../raw/lists.w3.org/Archives/Public/public-html/2009Sep/0566.html)（[公開元](https://lists.w3.org/Archives/Public/public-html/2009Sep/0566.html)） [Bug 7657](../../raw/www.w3.org/Bugs/Public/show_bug.cgi-2867df8a72c94218)（[公開元](https://www.w3.org/Bugs/Public/show_bug.cgi?id=7657)） [変更提案](../../raw/wiki.whatwg.org/index.php-ab175fe94c92f193)（[公開元](https://wiki.whatwg.org/index.php?title=Change_Proposal:_figure_and_details&oldid=4382)）
