...
WHATWG HTML Living Standardでは、URL解析に使うdocument base URLと、hyperlink navigationおよびform submissionに使うdefault navigable名を指定する。要素自体はそれ以外の内容を表さない。 [HTML Living Standard](../../raw/html.spec.whatwg.org/multipage/semantics.html)（[公開版](https://html.spec.whatwg.org/multipage/semantics.html#the-base-element)、2026-08-09確認）
...
|---|---|---|---|---|
| 1992-11-13（更新日） | [*HTML Tags*](../../raw/www.w3.org/History/19921103-hypertext/hypertext/WWW/MarkUp/Tags.html)（[公開元](https://www.w3.org/History/19921103-hypertext/hypertext/WWW/MarkUp/Tags.html)） | CERN公式HTML資料のhistorical snapshot | out-of-contextな文書でrelative addressを解決するためbase addressが必要だと説明し、tag formatは未定・未使用と記す。 | 2026-08-09 |
