...
WHATWG HTML Living Standardでは、計算結果またはuser actionの結果を表す。[HTML Living Standard](../../raw/html-living-standard/form-elements.html)（[公開版](https://html.spec.whatwg.org/multipage/form-elements.html#the-output-element)、2026-08-09確認）
...
|---|---|---|---|---|
| 2000-12-19 | [*XForms 1.0: XForms User Interface*](../../raw/xforms/4868c303683d37e8-ui.html)（[公開元](https://www.w3.org/TR/2000/WD-xforms-20001219/ui.html#N1052)） | W3C Working Draft | 非editableなdata value表示用`output` form control | 2026-08-10 |
| 2003-09 | [*XHTML Module: Extensions to Form Controls*](../../raw/web-forms-2/82571977abb19a62-hfp.html)（[公開元](https://www.hixie.ch/specs/html/forms/hfp.html)） | Opera Working Draft | HTML forms拡張の先行版には`output`要素がないこと | 2026-08-10 |
| 2003-12-04 | [*Proposed XHTML Module: XForms Basic*](../../raw/web-forms-2/224055341af55b0f-xforms-ba.html)（[公開元](https://www.hixie.ch/specs/html/forms/xforms-basic-1)） | Editor's Working Draft | XForms機能をHTML formsへ加える方針とHTML `output` | 2026-08-10 |
| 2003-12-07 | [“Re: Proposal for Extensions to HTML4”](../../raw/items/lists.w3.org/66dd601786c39e22-0010.html)（[公開元](https://lists.w3.org/Archives/Public/www-forms/2003Dec/0010.html)） | www-forms・編集者回答 | 動的boilerplate textをdata modelではなくcontentとして扱う設計判断 | 2026-08-10 |
| 2005-04-11 | [*Web Forms 2.0*](../../raw/web-forms-2/d0e8dd74a559943e-SUBM-web-forms2-200.html)（[公開元](https://www.w3.org/submissions/2005/SUBM-web-forms2-20050411/#the-output)） | W3C Member Submission | scriptで更新する`output`と計算例 | 2026-08-09 |
| 2010-03-04 | [*HTML5 differences from HTML4*](../../raw/w3c-html5-history/26cf49032665c8b9-WD-html5-diff-201.html)（[公開元](https://www.w3.org/TR/2010/WD-html5-diff-20100304/#changes-2009-04-23)） | W3C Working Draft | Web Forms 2.0のHTML5への統合 | 2026-08-09 |
| 2026-08-09 | [*HTML Living Standard: The output element*](../../raw/html-living-standard/form-elements.html)（[公開元](https://html.spec.whatwg.org/multipage/form-elements.html#the-output-element)） | 現行仕様 | `output`の現行定義 | 2026-08-09 |
