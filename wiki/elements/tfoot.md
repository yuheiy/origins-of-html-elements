...
| 1995-07-07 | *HTML Tables* `draft-ietf-html-tables-00` | IETF Internet-Draft | CALSのfeaturesを取り込んだhead/body/foot groupingとして`TFOOT`を定義し、paged outputの用途を記す。 | [IETF Datatracker](https://datatracker.ietf.org/doc/html/draft-ietf-html-tables-00.txt) | 2026-08-09 |
...
| 1997-12-18 | HTML 4.0 | W3C Recommendation | `TFOOT`をHTML 3.2以後の新要素として採録し、5要素を含むtable DTD blockをRFC 1942のIETF table standardへ帰属させる。 | [HTML 4.01 DTD](../../raw/html-4.01/strict.dtd)・[changes](https://www.w3.org/TR/html401/appendix/changes.html#h-A.3.1) | 2026-08-10 |
