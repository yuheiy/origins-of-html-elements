...
WHATWG HTML Living Standardでは、文書を他のresourceへ結び付け、`rel`によって文書とdestination resourceの関係を指定する。link typeに応じてhyperlinkまたはexternal resource linkになる。 [HTML Living Standard](../../raw/html.spec.whatwg.org/multipage/semantics.html)（[公開版](https://html.spec.whatwg.org/multipage/semantics.html#the-link-element)、2026-08-09確認）
