...
W3Cのクライアント側スクリプティング草案で、スクリプトまたはその言語に非対応のユーザーエージェントへ内容を示すため導入され、HTML 4で一般的な代替内容コンテナーへ整理された要素である。Netscape Navigator 3.0の実装も確認できるが、W3C案との前後関係と採録因果は未確認である。
...
1996年1月24日のW3C初期草案はCharlie Kindelの初稿を介してNetscapeのJavaScript拡張から派生し、Navigator 2.0 betaの`SCRIPT`を正式化すると明記するが、`NOSCRIPT`は定義しない。その後の6月27日版にも`NOSCRIPT`はなく、7月9日版に初めて定義が現れる。同版は、ユーザーエージェントがクライアント側スクリプティングまたは先行`SCRIPT`の言語を支援しない場合だけ内容を描画し、旧式ブラウザーへ更新呼びかけを提供する要素と説明する。エディターはDave Raggettである。[1月24日版](../../raw/www.w3.org/TR/WD-script-960124.html)（[公開元](https://www.w3.org/TR/WD-script-960124.html)） [6月27日版](../../raw/www.w3.org/TR/WD-script-960627.html)（[公開元](https://www.w3.org/TR/WD-script-960627.html)） [7月9日版](../../raw/www.w3.org/TR/WD-script-960709.html)（[公開元](https://www.w3.org/TR/WD-script-960709.html)）
...
1997年3月14日版は更新呼びかけ中心の説明を継承する。7月8日のHTML 4.0 First Public Working Draftは、スクリプトが実行されない場合の「alternate content」へ説明を一般化し、動的に生成されるデータを取得するリンクの例を示した。この設計がHTML 4.01まで維持された。[3月14日版](../../raw/www.w3.org/TR/WD-script-970314)（[公開元](https://www.w3.org/TR/WD-script-970314)） [HTML 4.0 FPWD](../../raw/www.w3.org/TR/WD-html40-970708/interact/scripts.html)（[公開元](https://www.w3.org/TR/WD-html40-970708/interact/scripts.html#h-9.2.2.1)） [HTML 4.01](../../raw/www.w3.org/TR/html401/interact/scripts.html)（[公開元](https://www.w3.org/TR/html401/interact/scripts.html#edef-NOSCRIPT)）
...
|---|---|---|---|---|
| 1996-01-24 | [*HTML3 Scripting*](../../raw/www.w3.org/TR/WD-script-960124.html)（[公開元](https://www.w3.org/TR/WD-script-960124.html)） | W3C Working Draft | 草案全体をNetscape拡張から派生したと説明し、Navigator 2.0 betaの`SCRIPT`を正式化するが、`NOSCRIPT`は定義しない。 | 2026-08-12 |
...
| 1997-07-08 | [HTML 4.0 First Public Working Draft §9.2.2.1](../../raw/www.w3.org/TR/WD-html40-970708/interact/scripts.html)（[公開元](https://www.w3.org/TR/WD-html40-970708/interact/scripts.html#h-9.2.2.1)） | W3C Working Draft | 更新呼びかけ中心の説明を一般的な代替内容へ変え、データ取得リンクを例示。 | 2026-08-12 |
...
Netscape Navigator 2.0を直接祖先とする説明。Navigator 2.0 betaの`SCRIPT`を正式化した1996年1月のW3C草案に`NOSCRIPT`はなく、NetscapeのHTML参照も`NOSCRIPT`をNavigator 3.0の機能とする。Navigator 3.0からW3C案、またはW3C案からNavigator 3.0への矢印は、公開日の前後と採録記録がないため保留する。SGML条件付きセクションからの由来も、機能の類似だけで採用因果がない。
