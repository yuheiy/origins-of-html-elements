...
WHATWG HTML Living Standardでは、`img`および子孫の`area`と組み合わせてimage mapを定義し、要素自体はその子を表す。`name`属性によって参照可能な名前を与える。[HTML Living Standard](../../raw/html.spec.whatwg.org/multipage/image-maps.html)（[公開版](https://html.spec.whatwg.org/multipage/image-maps.html#the-map-element)、2026-08-09確認）
