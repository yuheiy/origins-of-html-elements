...
一次定義: [WHATWG HTML Living Standardの `<dialog>` 定義](https://html.spec.whatwg.org/multipage/interactive-elements.html#the-dialog-element)（2026-08-09確認）。定義内容の要約は未作成。
