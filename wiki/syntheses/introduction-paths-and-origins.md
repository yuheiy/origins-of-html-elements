...
このページは、現行要素を現在の機能ではなく、HTMLへの導入経路と、HTML内部の変遷を通して確認できる設計背景から読むための地図である。個別要素の結論と証拠は[要素索引](../README.md#要素)、複数要素の確認済み経路と接続しない境界は[共有系譜](../lineages/README.md)と各詳細ページを正本とする。
...
共有系譜の詳細は、由来や標準化時期ではなく、複数の現行要素を同時に説明できる確認済みの接続単位で分ける。

- 初期の文書語彙と命名: [CERN-SGMLリスト群](../lineages/cern-sgml-lists.md)、[Texinfo](../lineages/texinfo.md)、[CALS表構造](../lineages/cals-tables.md)
- HTML拡張草案: [HTML+](../lineages/html-plus.md)、[IETF国際化](../lineages/html-internationalization.md)、[HTML 4フォーム](../lineages/html4-form-accessibility.md)
- 既存Webとアクセシビリティ語彙: [WHATWG文書構造](../lineages/whatwg-sectioning.md)、[ARIAランドマーク](../lineages/aria-landmarks.md)、[ルビ](../lineages/ruby.md)
- ブラウザー機能と外部プラットフォームの統合: [外来要素](../lineages/foreign-content.md)、[開閉UI](../lineages/details-summary.md)、[メディア](../lineages/media-elements.md)、[レスポンシブ画像](../lineages/responsive-images.md)
